...
function initDisabledTextAreaTD(newTD,tdID,count,value,width){
    newTD.id = tdID;
...
function initEnabledTextAreaTD(newTD,tdID,count,value,width){
    newTD.id = tdID;
    newTD.setAttribute("class", "GMColorNoFocus GMRow GMText GMCell");
    newTD.setAttribute("className","GMColorNoFocus GMRow GMText GMCell");
...
function initEnabledLinkTD(agileURL,newTD,tdID,value,subclassid){
    newTD.id = tdID;
    newTD.setAttribute("class", "GMColorNoFocus GMRow GMText GMCell");
    newTD.setAttribute("className","GMColorNoFocus GMRow GMText GMCell");
    
    newTD.innerHTML = showMutiList(agileURL,value,subclassid);
    console.log(value);
}
